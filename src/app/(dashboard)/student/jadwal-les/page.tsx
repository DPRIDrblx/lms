...
export default function JadwalLesPage() {
  ...
  const fetchData = async () => {
    ...
    if (schedData) {
      ...
      const filtered = schedData.filter((s: any) => new Date(s.schedule_time) >= today || s.summary);
      // We also show past schedules if they have a summary so students can review them.
