...
export default function TalentMappingDashboard() {
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-64px)] overflow-hidden">
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-6 pb-24 relative z-10">
        
        {/* User Card */}
        <motion.div 
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          className="bg-white rounded-3xl p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-slate-100 relative overflow-hidden"
        >
          {/* Badge */}
          <div className="flex items-center justify-center gap-1.5 w-fit mx-auto bg-amber-50 text-amber-600 px-3 py-1 rounded-full text-xs font-bold mb-4">
          ...
          <button className="w-full bg-amber-400 hover:bg-amber-500 text-amber-950 font-bold py-3.5 rounded-2xl transition-colors shadow-sm active:scale-[0.98]">
            Mulai Belajar
          </button>
        </motion.div>
        ...
        >
          <Link href="/student/talent-mapping/roadmap" className="block bg-emerald-50 rounded-3xl p-5 border border-emerald-100 hover:shadow-md transition-all">
        ...
        <motion.div 
          ...
          className="bg-white rounded-3xl p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-slate-100 flex flex-col items-center relative overflow-hidden"
        >
